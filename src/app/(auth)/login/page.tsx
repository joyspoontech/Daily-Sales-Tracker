    ...
    return (
        <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2 min-h-screen bg-[var(--color-background)] mx-auto">
            <div className="flex flex-col items-center justify-center mb-8">
                ...
                <h1 className="text-3xl font-bold text-[var(--color-primary)]">Joyspoon</h1>
                <p className="text-[var(--color-secondary)] text-sm opacity-80 mt-1">Daily Sales Tracker</p>
            </div>

            <form className="animate-in flex-1 flex flex-col w-full justify-center gap-4 text-[var(--color-foreground)]">
                <div className="card w-full">
                    <div className="flex flex-col gap-4">
                        <h2 className="text-xl font-semibold text-[var(--color-primary)] mb-2">Welcome Back</h2>
                        ...
                        <button formAction={login} className="btn-primary mt-4 w-full h-[52px]">
                            Sign In
                        </button>
                        <Link href="/signup" className="btn-secondary w-full h-[52px]">
                            Sign Up (Sales)
                        </Link>
                    </div>
                </div>
